...
import { OpenHandsTab } from '~/components/@settings/tabs/OpenHandsTab.client';
...
const BETA_TABS = new Set<TabType>(['task-manager', 'service-status', 'update', 'local-providers', 'openhands']);
